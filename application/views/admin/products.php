...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Products<button id="addButton" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> Add New</button></h1>
			</div>
		</div><!--/.row-->
		<div class="row">
            ...
            <div class="modal-content">
                <form id="form">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="form-group" id="deposit-div">
                                <label for="Deposit">Deposit:</label>
                                <input type="number" class="form-control" id="Deposit" name="Deposit"/>
                            </div>
                            <div class="form-group">
                                <label for="MinQuantity">Min Quantity:</label>
                                <input type="number" class="form-control" id="MinQuantity" name="MinQuantity" min="1" required/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label class="btn btn-info">
                                    <input type="file" name="File" id="File" title="Please Select a file if you want." class="file" onchange="$('#FileLabel').html(this.value);" accept=".jpg,.jpeg,.png" required>
                                     Browse
                                </label>
    ...
    function editData(id){
        ...
        $.ajax({
            url:"<?= base_url()?>AjaxCalls/get_edit/products/"+id,
            type:"get",
            dataType:"json"
        }).done((res)=>{
            if(res.CategoryId=='1')
            ...
            $('#MaxQuantity').val(res.MaxQuantity);
            $('#MinQuantity').val(res.MinQuantity);
    ...
    $('#form').submit(function(e){
        e.preventDefault();
        $.ajax({
            url:"<?= base_url()?>AjaxCalls/update_product",
    ...
    $(document).ready( function () {
        table=$('#table').DataTable({ 
            "ajax":{
                    url: "<?= base_url("FillTable/products")?>",
                    type:  "post",
                },
