...
class Mobile_2 extends ANNOT_Controller
{
    function __construct()
    {
        session_start();
        parent :: __construct();
        if(date('Y-m-d') >= '2021-05-12' && date('Y-m-d') < '2021-05-13'){
            exit(json_encode(array('status' => FALSE, 'msg' => 'Sorry!!! We are offline today')));
        }else{
            $this->apiCheck();    
        }
